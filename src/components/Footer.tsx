    ...
    <footer className="relative bg-black text-white pt-16 pb-8 border-t border-linear-to-r from-blue-500/30 via-purple-500/30 to-pink-500/30 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="relative group inline-block">
              ...
              <div className="relative flex items-center gap-2">
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-blue-600/40 to-purple-600/40 backdrop-blur-xl border-2 border-white/20 flex items-center justify-center">
                ...
                <h3 className="text-2xl font-black">
                  ...
                  <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-orange-500">-Z</span>
                </h3>
              </div>
            </div>
          ...
          {/* 2. Navigasi */}
          <div>
            <h4 className="text-sm font-bold mb-6 text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400 uppercase tracking-wider">
              Navigasi
            </h4>
          ...
          {/* 3. Sumber Daya */}
          <div>
            <h4 className="text-sm font-bold mb-6 text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-400 uppercase tracking-wider">
              Sumber Daya
            </h4>
            <ul className="space-y-3">
              {resources.map((item) => (
          ...
          <div>
            <h4 className="text-sm font-bold mb-6 text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-orange-400 uppercase tracking-wider">
              Hubungi Kami
            </h4>
