...
const aboutt = [
  {
    ...
    image: "https://images.unsplash.com/photo-1581090698407-7d93959da202?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGlub3ZhdGlvbnxlbnwwfHwwfHx8MA%3D%3D",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1758876021444-3885d0a2539f?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
];
...
const About: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto py-16 px-4">
      ...
      <h3 className=" w-2xl text-xl text-center mb-12 text-gray-500 mx-auto">Gen Z hadir untuk memberdayakan generasi muda Indonesia menghadapi era disrupsi dengan percaya diri dan keterampilan yang tepat.</h3>
